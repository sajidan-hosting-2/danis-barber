...
<body>
    ...
    <div class="sosmed-float">
        <a href="https://wa.me/6282126982529"
           target="_blank"
           rel="noopener noreferrer"
           class="wa-float"
           title="Chat WhatsApp"
           aria-label="Chat WhatsApp Jompi TimHairstylist">
            <i class="fab fa-whatsapp" aria-hidden="true"></i>
        </a>
        <a href="https://www.instagram.com/jompi_timhairstylist?utm_source=qr"
           target="_blank"
           rel="noopener noreferrer"
           class="ig-float"
           title="Follow Instagram"
           aria-label="Instagram Jompi TimHairstylist">
    ...
    <main id="main-content">
        ...
        <header class="hero-section">
            <div class="container hero-row">
                ...
                <div class="hero-copy text-start">
                    <h1 class="fw-bold mb-3 text-white">💈 Jompi TimHairstylist 💈</h1>
                    <h2 class="fw-bold mb-3 text-white fs-1">Acara Makin Berkesan</h2>
                    <p class="lead mb-4 text-white">Hair Stylist with Jompi & Tim</p>
                    <p class="h4 mb-5 text-white">Paket lengkap untuk calon pengantin pria,<br> tampil percaya diri & berkelas di hari bahagia.</p>
                    <a href="#paket" class="btn btn-cta-accessible btn-lg">Lihat Paket</a>
                </div>
            </div>
        </header>
        ...
        <!-- Packages Section -->
        <section id="paket" class="py-5 section-dark section-padding">
            <div class="container">
                ...
                <div class="row g-4 justify-content-center mb-5">
                    <div class="col-md-4">
                        <div class="card kontak-card h-100 p-4 text-center">
                            ...
                            <h3 class="h5 fw-bold text-cream">Alamat</h3>
                    ...
                    <div class="col-md-4">
                        <div class="card kontak-card h-100 p-4 text-center">
                            ...
                            <h3 class="h5 fw-bold text-cream">WhatsApp</h3>
                            <p class="text-muted-custom small mb-2">+62 821-2698-2529</p>
                            <a href="https://wa.me/6282126982529" target="_blank" rel="noopener noreferrer" class="btn btn-success btn-sm">
                    ...
                    <div class="col-md-4">
                        <div class="card kontak-card h-100 p-4 text-center">
                            ...
                            <h3 class="h5 fw-bold text-cream">Instagram</h3>
                            <p class="text-muted-custom small mb-2">@jompi_timhairstylist</p>
                            <a href="https://www.instagram.com/jompi_timhairstylist?utm_source=qr" target="_blank" rel="noopener noreferrer" class="btn btn-danger btn-sm">
                                <i class="fab fa-instagram" aria-hidden="true"></i> Follow
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="row align-items-start g-4 g-lg-4">
                    <div class="col-12 col-lg-6">
                        ...
                        <div class="keunggulan-box p-4">
                            <h3 class="h4 fw-bold mb-2 text-gold">Keunggulan</h3>
                    ...
                    <div class="col-12 col-lg-6">
                        ...
                        <a href="https://wa.me/6282126982529" target="_blank" rel="noopener noreferrer" class="btn btn-gold btn-lg w-100 fw-bold my-3">
                            <i class="fab fa-whatsapp me-2" aria-hidden="true"></i> Chat WhatsApp Sekarang
                        </a>
        ...
        <div class="container">
            <div class="row mb-5">
                <div class="col-md-4 mb-4">
                    ...
                    <h3 class="h5 fw-bold text-gold mb-3">Jompi TimHairstylist</h3>
                    <p class="small text-muted-custom">
                        Layanan penata rambut profesional khusus pria untuk acara pernikahan. Buat pengantin pria Anda tampil percaya diri dan berkelas di hari bahagia.
                    </p>
                </div>

                <div class="col-md-4 mb-4">
                    <h3 class="h5 fw-bold text-gold mb-3">Menu</h3>
                ...
                <div class="col-md-4 mb-4">
                    <h3 class="h5 fw-bold text-gold mb-3">Hubungi Kami</h3>
                    <ul class="list-unstyled small text-muted-custom">
                        ...
                        <li class="mb-2"><i class="fab fa-instagram text-gold me-2"></i><a href="https://www.instagram.com/jompi_timhairstylist" target="_blank" rel="noopener noreferrer" class="footer-link">@jompi_timhairstylist</a></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="row mb-4">
                <div class="col-12 text-center">
                    <h3 class="h6 fw-bold text-gold mb-3">Ikuti Kami</h3>
                    <div class="d-flex justify-content-center gap-3">
                        <a href="https://wa.me/6282126982529" target="_blank" rel="noopener noreferrer" class="social-icon" aria-label="Chat WhatsApp Jompi TimHairstylist">
                            <i class="fab fa-whatsapp" aria-hidden="true"></i>
                        </a>
                        <a href="https://www.instagram.com/jompi_timhairstylist?utm_source=qr" target="_blank" rel="noopener noreferrer" class="social-icon" aria-label="Instagram Jompi TimHairstylist">
                            <i class="fab fa-instagram" aria-hidden="true"></i>
                        </a>
                        <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" class="social-icon" aria-label="Facebook Jompi TimHairstylist">
